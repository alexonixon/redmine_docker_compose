...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<ttfunk>, ["~> 1.1.1"])
      s.add_runtime_dependency(%q<pdf-core>, ["~> 0.2.2"])
      ...
      s.add_dependency(%q<ttfunk>, ["~> 1.1.1"])
      s.add_dependency(%q<pdf-core>, ["~> 0.2.2"])
